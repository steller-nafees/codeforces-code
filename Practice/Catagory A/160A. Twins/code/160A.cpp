//============================================================================
// Platform      : Codeforces 
// Problem Title : 160A. Twins
// Author        : H M Nafees N Islam
// Institution   : North South University (NSU), Computer Science And Engineering
// Date          : March 14, 2026 
//
// Problem Statement:
//   You and your twin found n coins with values a1, a2, ..., an.
//   Your mother asked you to divide the coins equally, but you decide
//   to take some coins for yourself so that the total value of the
//   coins you take is strictly greater than the total value of the
//   coins left for your twin.
//
//   However, to avoid suspicion, you want to take the minimum possible
//   number of coins that still satisfies this condition.
//
//   Determine the minimum number of coins you must take so that the
//   sum of their values is strictly greater than the sum of the
//   remaining coins.
//
// Input:
//   - The first line contains an integer n (1 ≤ n ≤ 100) — number of coins.
//   - The second line contains n integers a1, a2, ..., an (1 ≤ ai ≤ 100)
//     representing the value of each coin.
//
// Output:
//   - Print a single integer — the minimum number of coins needed so that
//     their total value is strictly greater than the sum of the remaining coins.
//
// Constraints:
//   - 1 ≤ n ≤ 100
//   - 1 ≤ ai ≤ 100
...
/*
   Solution Logic:
   - First, calculate the total sum of all coin values.
   - To minimize the number of coins taken while maximizing value,
     sort the coins in descending order.
   - Start taking coins from the largest value and keep adding
     them to your sum.
   - Count how many coins you have taken.
   - Stop when your sum becomes strictly greater than the sum
