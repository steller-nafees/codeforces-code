//============================================================================
// Platform      : Codeforces 
// Problem Title : 405A. Gravity Flip
// Author        : H M Nafees N Islam
// Institution   : North South University (NSU), Computer Science And Engineering
// Date          : March 19, 2026 
//
// Problem Statement:
//   Little Chris has a toy box with n columns of cubes. The i-th column
//   contains ai cubes. Initially, gravity pulls cubes downward.
//
//   When gravity is switched, cubes fall to the right side of the box.
//   You need to determine the number of cubes in each column after
//   the gravity switch.
//
// Input:
//   - First line: integer n (1 ≤ n ≤ 100), number of columns
//   - Second line: n integers ai (1 ≤ ai ≤ 100)
//
// Output:
//   - Print n integers representing the number of cubes in each column
...
/*
   Solution Logic:
  - When gravity is switched to the right, cubes will "fall" and align in non-decreasing order.
  - This means shorter columns come first and taller columns move to the right.
  - Therefore, we simply sort the array in ascending order.
  - Output the sorted array as the final configuration.
*/
