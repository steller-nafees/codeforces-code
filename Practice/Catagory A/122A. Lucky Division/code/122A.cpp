//============================================================================
// Platform      : Codeforces 
// Problem Title : 122A. Lucky Division
// Author        : H M Nafees N Islam
// Institution   : North South University (NSU), Computer Science And Engineering
// Date          : February 23, 2026 
//
// Problem Statement:
//   Petya loves lucky numbers. Lucky numbers are positive integers whose
//   decimal representation contains only the digits 4 and 7.
//   Examples of lucky numbers: 4, 7, 47, 744.
//   Non-lucky numbers: 5, 17, 467.
//
//   A number is called almost lucky if it is divisible by at least
//   one lucky number.
//
...
/*
   ...
   - Since n ≤ 1000, possible lucky divisors within range are:
       4, 7, 47, 74, 444, 447, 474, 477, 744, 747, 774, 777 ...
   - In this implementation, we check divisibility by the most relevant
     lucky numbers within range: 4, 7, 47, and 74.
   - If n is divisible by any of them, print "YES".
   - Otherwise, print "NO".
   - Time Complexity: O(1)
*/
