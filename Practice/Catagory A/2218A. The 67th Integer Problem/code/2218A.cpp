//============================================================================
// Platform      : Codeforces 
// Problem Title : 2218A. The 67th Integer Problem
// Author        : H M Nafees N Islam
// Institution   : North South University (NSU), Computer Science And Engineering
// Date          : April 12, 2026 
//
// Problem Statement:
//   Given an integer x, choose an integer y (−67 ≤ y ≤ 67) such that
//   the value of min(x, y) is maximized.
//
//   If there are multiple valid y, output any of them.
//
// Input:
...
//
// Output:
//   For each test case, output an integer y such that min(x, y)
//   is maximized.
//
// Constraints:
//  - 1 ≤ t ≤ 6767
...
/*
   Solution Logic:
  - We want to maximize the value of min(x, y).
  - The maximum possible value of min(x, y) is x itself, because min(x, y) ≤ x.
  - To achieve min(x, y) = x, we must choose y ≥ x.
  - Since y is allowed to be any integer in the range [−67, 67], we can simply choose y = x.
  - This guarantees min(x, y) = x, which is the maximum possible value.
  - Hence, printing x directly is always a valid and optimal solution.
*/
