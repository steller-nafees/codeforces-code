//============================================================================
// Platform      : Codeforces 
// Problem Title : 2208A. Bingo Candies
// Author        : H M Nafees N Islam
// Institution   : North South University (NSU), Computer Science And Engineering
// Date          : March 15, 2026 
//
// Problem Statement:
// Alice has a magic board represented by an n × n grid. Each tile contains
// a colored candy. The color of the candy in the i-th row and j-th column
// is denoted by ai,j.
//
// Bob wants to know whether it is possible to rearrange the candies on the
// board so that no row or column contains n candies of the same color.
//
// In other words, after rearrangement, every row and every column must
// contain at least two different candy colors.
//
...
// For each test case:
//
//  • The first line contains an integer n (1 ≤ n ≤ 100) — the size of the board.
//  • The next n lines each contain n integers.
//    The j-th integer of the i-th line represents ai,j (1 ≤ ai,j ≤ n²),
//    the color of the candy at position (i, j).
//
// Output:
// For each test case, print "YES" if a valid rearrangement exists,
// otherwise print "NO".
//
...
/*
   Solution Logic:
   - We read the n × n grid and count the frequency of each candy color.
   - The total number of candies is n².
   - If any color appears more than n × (n − 1) times, then it is impossible
     to rearrange the board such that every row and column contains at least
     two different colors.
   - This is because at least one full row or column would inevitably contain
     candies of the same color.
   - Therefore:
        • If a color frequency > n × (n − 1) → print "NO"
        • Otherwise → print "YES"
*/
