//============================================================================
// Platform      : Codeforces 
// Problem Title : 1837A. Grasshopper on a Line
// Author        : H M Nafees N Islam
// Institution   : North South University (NSU), Computer Science And Engineering
// Date          : January 21, 2026 
//
// Problem Statement:
//   You are given two integers x and k. A grasshopper starts at point 0 on the
//   OX axis. In one move, it can jump an integer distance (positive or negative)
//   that is NOT divisible by k.
//
//   The task is to determine the minimum number of moves required to reach
//   exactly point x, and also print the jump distances used.
//
// Input:
//   The first line contains an integer t — the number of test cases.
//   Each test case consists of two integers x and k.
//
// Output:
//   For each test case:
//   - Print an integer n — the minimum number of moves.
//   - Print n integers representing the jumps (each not divisible by k).
//     Positive values mean right jumps, negative values mean left jumps.
//
// Constraints:
//   - 1 ≤ t ≤ 1000
//   - 1 ≤ x ≤ 100
...
/*
   Solution Logic:
   - If x is NOT divisible by k, the grasshopper can directly jump from 0 to x
     in one move since the jump length x satisfies the condition.
   - If x IS divisible by k, a single jump of length x is invalid.
     In this case, split the movement into two jumps:
       (x - k - 1) and (k + 1).
     Both values are not divisible by k, and their sum equals x.
   - This guarantees the minimum number of moves (1 or 2).
*/
