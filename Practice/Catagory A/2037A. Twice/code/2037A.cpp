//============================================================================
// Platform      : Codeforces 
// Problem Title : 2037A. Twice
// Author        : H M Nafees N Islam
// Institution   : North South University (NSU), Computer Science And Engineering
// Date          : February 10, 2026 
//
// Problem Statement:
// Kinich has an array of n integers. He can repeatedly select two distinct 
// indices i < j where a[i] = a[j] and neither index has been chosen before. 
// Each such pair increases his score by 1. Output the maximum score.
//
// Input:
...
//
// Output:
//  - Maximum score achievable for each test case
//
// Constraints:
//  - 1 ≤ t ≤ 500
//  - 1 ≤ n ≤ 20
...
void solve()
{
    ...
    vector<int> freq(21, 0);  // safe size
