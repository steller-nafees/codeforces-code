//============================================================================
// Platform      : Codeforces 
// Problem Title : 479A. Expression
// Author        : H M Nafees N Islam
// Institution   : North South University (NSU), Computer Science And Engineering
// Date          : April 17, 2026 
//
// Problem Statement:
//   Petya is given three positive integers a, b, and c.
//   He needs to insert '+' and '*' operators between them,
//   and can also use parentheses to maximize the result.
//
...
//
// Input:
//   Three integers a, b, and c (1 ≤ a, b, c ≤ 10).
//
// Output:
//   Print the maximum value obtainable.
//
// Constraints:
//   - 1 ≤ a, b, c ≤ 10
//   - Time limit: 1 second
...
/*
   Solution Logic:
  - Since we can only place '+' and '*' between a, b, c and use parentheses,
    we try all meaningful combinations.
  - Possible maximum expressions:
      1. a + b + c
      2. a * b * c
      3. (a + b) * c
      4. a * (b + c)
  - Evaluate all these cases and take the maximum.
  - Constraints are small, so brute force over all valid expressions is sufficient.
*/
