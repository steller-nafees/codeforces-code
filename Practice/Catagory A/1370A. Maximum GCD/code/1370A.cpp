//============================================================================
// Platform      : Codeforces 
// Problem Title : 1370A. Maximum GCD
...
//   Among all pairs of distinct integers in this range, find the maximum 
//   possible greatest common divisor of integers in a pair. Formally, find 
//   the maximum value of gcd(a,b), where 1≤a<b≤n.
//
// Input:
//   - The first line contains an integer t (1 ≤ t ≤ 100) — the number of test cases.
//   - Each test case contains a single integer n (2 ≤ n ≤ 10^6).
//
// Output:
...
/*
   Solution Logic:
  - Among all pairs (a, b) where 1 ≤ a < b ≤ n, the maximum GCD is achieved 
    when the pair is (n, n/2) or numbers close to n/2.
  - Hence, the maximum GCD is simply floor(n/2).
*/
