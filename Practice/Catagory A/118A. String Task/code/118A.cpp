//============================================================================
// Platform      : Codeforces 
// Problem Title : 118A. String Task
...
//   task was to write a simple program. The program was supposed to do the 
//   following operations on a given string consisting of uppercase and 
...
//
//   Help Petya implement this program.
//
// Input:
...
//
// Output:
//   Print the resulting string after performing the described operations.
//   It is guaranteed that the resulting string is not empty.
//
// Constraints:
...
/*
   ...
   - Convert each character to lowercase to handle uppercase letters.
   - If the character is NOT a vowel (a, e, i, o, u, y):
        • Append '.' before the character.
        • Append the lowercase consonant.
