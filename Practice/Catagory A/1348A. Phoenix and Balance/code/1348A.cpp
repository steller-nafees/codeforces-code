//============================================================================
// Platform      : Codeforces 
// Problem Title : 1348A. Phoenix and Balance
// Author        : H M Nafees N Islam
// Institution   : North South University (NSU), Computer Science And Engineering
// Date          : February 09, 2026 
//
// Problem Statement:
//   Phoenix has n coins, where the value of the i-th coin is 2^i.
//   He wants to split these coins into two piles such that the absolute
//   difference between the sum of the values in the two piles is maximized.
//
//   You must determine the maximum possible absolute difference.
//
// Input:
//   The first line contains an integer t — the number of test cases.
//   Each test case contains a single integer n — the number of coins.
//
// Output:
//   For each test case, print a single integer — the maximum possible
//   absolute difference between the sums of the two piles.
//
// Constraints:
//   - 1 ≤ t ≤ 10^4
//   - 2 ≤ n ≤ 30
...
/*
   Solution Logic:
   - The values of the coins are powers of 2: 2¹, 2², ..., 2ⁿ.
   - To maximize the absolute difference, place the largest coin (2ⁿ)
     and the smallest (n/2 - 1) coins in one pile.
   - Place the remaining coins in the second pile.
   - Compute the sum of both piles and take the absolute difference.
   - This greedy distribution guarantees the maximum possible difference.
*/
