//============================================================================
// Platform      : Codeforces 
// Problem Title : 1352C. K-th Not Divisible by n
// Author        : H M Nafees N Islam
// Institution   : North South University (NSU), Computer Science And Engineering
// Date          : March 06, 2026 
//
// Problem Statement:
//   You are given two positive integers n and k. Consider the sequence of all
//   positive integers that are NOT divisible by n. From this sequence,
//   determine the k-th number.
//
//   In other words, if we list all positive integers except those divisible
//   by n, we need to find the k-th number in that filtered sequence.
//
// Input:
...
void solve()
{
    ...
    ll divisbleCount = (k-1) / (n-1);
    ll ans = k + divisbleCount;
...
/*
   Solution Logic:
  - For g groups, we get (k-1)/g numbers that are divisible by n. So for n-1 its (k-1)/(n-1)
  - So Answer is k + ((k-1)/(n-1))
*/
