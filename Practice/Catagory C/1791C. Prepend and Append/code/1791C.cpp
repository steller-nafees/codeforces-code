//============================================================================
// Platform      : Codeforces 
// Problem Title : 1791C. Prepend and Append
// Author        : H M Nafees N Islam
// Institution   : North South University (NSU), Computer Science And Engineering
// Date          : December 04, 2025 
//
// Problem Statement:
//   Timur began with some binary string (possibly empty). He repeatedly performed
//   the following operation any number of times:
//
//       • Add '0' to one end of the string,
//       • Add '1' to the other end of the string.
//
//   From the final binary string s, determine the shortest possible length of
//   the original string he could have started with.
//
// Input:
//   • t — number of test cases (1 ≤ t ≤ 100)
//   • For each test case:
//       - n — length of the final string s (1 ≤ n ≤ 2000)
//       - s — final binary string
//
// Output:
//   For each test case, print the smallest possible length of the original string.
//   The original string may be empty, so the answer may be 0.
//
// Constraints:
//   - Time limit: 1 second
//   - Memory limit: 256 MB
...
/*
   Solution Logic:
  - Each operation adds '0' to one side and '1' to the other side.
  - This always creates a mismatched pair at both ends: (0 on one side, 1 on the other).
  - Therefore, as long as the outer characters differ, they could have been added
    in such an operation.
  - We simulate removing such matching "operation pairs" from both sides:
        while (left < right and s[left] != s[right])
            shrink inward
  - The remaining substring is the shortest possible original string.
  - Its length is max(0, right - left + 1).
*/
