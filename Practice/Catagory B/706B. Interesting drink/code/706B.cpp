//============================================================================
// Platform      : Codeforces 
// Problem Title : 706B. Interesting drink
// Author        : H M Nafees N Islam
// Institution   : North South University (NSU), Computer Science And Engineering
// Date          : March 08, 2026 
//
// Problem Statement:
//   Vasiliy likes to rest after a hard work, so you may often meet him in some
//   bar nearby. As all programmers do, he loves the famous drink "Beecola",
//   which can be bought in n different shops in the city. It's known that the
//   price of one bottle in the shop i is equal to xi coins.
//
//   Vasiliy plans to buy his favorite drink for q consecutive days. He knows
//   that on the i-th day he will be able to spend mi coins. For each day,
//   determine how many different shops he can buy a bottle of "Beecola" from.
//
// Input:
//   - The first line contains an integer n (1 ≤ n ≤ 100000) — number of shops.
//   - The second line contains n integers xi (1 ≤ xi ≤ 100000) — price of a
//     bottle in each shop.
//   - The third line contains an integer q (1 ≤ q ≤ 100000) — number of days.
//   - Each of the next q lines contains an integer mi (1 ≤ mi ≤ 10^9) — the
//     number of coins Vasiliy can spend on that day.
//
// Output:
//   - Print q integers.
//   - The i-th integer represents the number of shops where Vasiliy can buy
//     a bottle on the i-th day.
//
// Constraints:
//  - 1 ≤ n ≤ 100000
//  - 1 ≤ q ≤ 100000
...
/*
   Solution Logic:
   - First read the number of shops and the prices of Beecola bottles.
   - Sort the price array in ascending order.
   - For each query (each day), Vasiliy has mi coins.
   - We need to count how many shop prices are ≤ mi.
   - Use Binary Search on the sorted array to find the last index where price ≤ mi.
